...
import asadRizviResume from '../assets';
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description: 'These are scripts tailored for scraping specific data from certain sites and storing them in a csv file. This repo will contain all the scripts for various functions. Languages: Python',
  ...
  },
  {
    ...
    description: 'A simple to-do list with add, view and delete functionality. Built with Spring Boot, React and PostgreSQL. Languages: Java, javascript, HTML, CSS',
